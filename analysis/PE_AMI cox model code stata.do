...
import delim using "output/input_sampled_data_ate_covid_pheno_hospitalised_vaccinated_reduced_time_periods.csv" 
log using "output/PE_AMI_cox_stata", replace
