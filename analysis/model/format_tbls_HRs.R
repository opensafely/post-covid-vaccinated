...
rmarkdown::render("analysis/model/compiled_event_counts.Rmd",output_file=paste0("/suppressed_compiled_event_counts_",event_name,"_", cohort),output_dir="output/review/model")
...
rmarkdown::render("analysis/model/compiled_HR_results.Rmd",output_file=paste0("/suppressed_compiled_HR_results_",event_name,"_", cohort),output_dir="output/review/model")
