...
ggplot2::ggplot(data =pheno_results,
  ...
  #ggplot2::scale_y_continuous(lim = c(0,3)) +
  ...
  ggplot2::scale_fill_manual(values = levels(pheno_results$colour), labels = levels(pheno_results$strata)) +
  ggplot2::scale_color_manual(values = levels(pheno_results$colour), labels = levels(pheno_results$strata)) +
  ggplot2::scale_shape_manual(values = c(21,22), labels = levels(pheno_results$strata)) +
