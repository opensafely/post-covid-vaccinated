# Filter to individuals without a second vaccination ---------------------------
# NB: People with one vaccination before study end can be eligible depending on dates

tmp <- tmp[is.na(tmp$vax_date_covid_2),]

# Remove dynammic variables from vaccinated dataset ----------------------------
