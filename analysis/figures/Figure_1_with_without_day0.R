...
ggplot2::ggsave(paste0(output_dir,"Figure_1_day0_reduced.png"), height = 210, width = 297, unit = "mm", dpi = 600, scale = 1)
...
ggplot2::ggsave(paste0(output_dir,"Figure_1_without_day0.pdf"), height = 210, width = 297, unit = "mm", dpi = 600, scale = 1)
