/*----------------------------------------------------------------------------
Do file name: 			cox_models for day 0 events
Project: 				Project 12: Post covid CVD events
Date:					06/11/2023
Author:					Venexia Walker and Rachel Denholm
					Genevieve Cezard for adaption to m1split
...
stsplit days, after(exposure_date) at(0 1 7 14 21 28 197 535)
...
stcox days0_1 days1_7 days7_14 days14_21 days21_28 days28_197 days197_535 i.sex age_spline1 age_spline2, strata(region) vce(r)
est store min, title(Age_Sex)
stcox days0_1 days1_7 days7_14 days14_21 days21_28 days28_197 days197_535 i.sex age_spline1 age_spline2 i.cov_bin_obesity, vce(r)
est store age_sex_obesity, title(Age_Sex_Obesity)
stcox days0_1 days1_7 days7_14 days14_21 days21_28 days28_197 days197_535 i.sex age_spline1 age_spline2 i.cov_cat_ethnicity i.cov_cat_deprivation i.cov_cat_smoking_status cov_num_consulation_rate cov_bin_*, strata(region) vce(r)
...
keep patient_id days0_1 days1_7 days7_14 days14_21 days21_28 days28_197 days197_535 follow_up
...
export delimited using "output/`cpf'_stata_median_fup_m1split", replace
