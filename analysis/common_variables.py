...
def generate_common_variables(index_date_variable):
    ...
    ## Smoking status
        ...
        ## Prior AMI
            ### Primary care
            prior_ami_snomed=patients.with_these_clinical_events(
                ami_snomed_clinical,
            ...
            ### HES APC
            prior_ami_prior_icd10_hes=patients.admitted_to_hospital(
                returning='binary_flag',
            ...
            prior_ami_icd10_hes=patients.admitted_to_hospital(
                returning='binary_flag',
                with_these_diagnoses=ami_icd10,
                on_or_before=f"{index_date_variable}",
                date_format="YYYY-MM-DD",
            ...
            cov_bin_ami=patients.maximum_of(
                "prior_ami_snomed", "prior_ami_prior_icd10_hes", "prior_ami_icd10_hes",
            ),

        ## Prior all stroke
            ### Primary care
            prior_stroke_isch_snomed=patients.with_these_clinical_events(
                stroke_isch_snomed_clinical,
                returning='binary_flag',
                on_or_before=f"{index_date_variable}",
                date_format="YYYY-MM-DD",
            ...
            prior_stroke_sah_hs_snomed=patients.with_these_clinical_events(
                stroke_sah_hs_snomed_clinical,
                returning='binary_flag',
                on_or_before=f"{index_date_variable}",
                date_format="YYYY-MM-DD",
            ...
            ### HES APC
            prior_stroke_isch_icd10_hes=patients.admitted_to_hospital(
                returning='binary_flag',
                with_these_diagnoses=stroke_isch_icd10,
                on_or_before=f"{index_date_variable}",
                date_format="YYYY-MM-DD",
            ...
            prior_stroke_sah_hs_icd10_hes=patients.admitted_to_hospital(
                returning='binary_flag',
                with_these_diagnoses=stroke_sah_hs_icd10,
                on_or_before=f"{index_date_variable}",
                date_format="YYYY-MM-DD",
            ...
            cov_bin_all_stroke=patients.maximum_of(
                "prior_stroke_isch_icd10_hes", "prior_stroke_isch_snomed", "prior_stroke_sah_hs_icd10_hes", "prior_stroke_sah_hs_snomed",
            ),
        ...
        ## Prior venous thrombolism events
            ### Primary care
            prior_venous_thrombolism_events_snomed=patients.with_these_clinical_events(
                all_vte_codes_snomed_clinical,
                returning='binary_flag',
                on_or_before=f"{index_date_variable}",
                date_format="YYYY-MM-DD",
            ...
            ### HES APC
            prior_venous_thrombolism_events_icd10_hes=patients.admitted_to_hospital(
                returning='binary_flag',
                with_these_diagnoses=all_vte_codes_icd10,
                on_or_before=f"{index_date_variable}",
                date_format="YYYY-MM-DD",
            ...
            ### Combined
            cov_bin_venous_thrombolism_events=patients.maximum_of(
                "prior_venous_thrombolism_events_snomed", "prior_venous_thrombolism_events_icd10_hes",
            ),

        ## Prior heart failure
            ### Primary care
            prior_heart_failure_events_snomed=patients.with_these_clinical_events(
                hf_snomed_clinical,
                returning='binary_flag',
                on_or_before=f"{index_date_variable}",
                date_format="YYYY-MM-DD",
            ...
            ### HES APC
            prior_heart_failure_events_icd10_hes=patients.admitted_to_hospital(
                returning='binary_flag',
                with_these_diagnoses=hf_icd10,
                on_or_before=f"{index_date_variable}",
                date_format="YYYY-MM-DD",
            ...
            ### Combined
            cov_bin_heart_failure=patients.maximum_of(
                "prior_heart_failure_events_snomed", "prior_heart_failure_events_icd10_hes",
            ),

        ## Prior angina
            ### Primary care
            prior_angina_events_snomed=patients.with_these_clinical_events(
                angina_snomed_clinical,
                returning='binary_flag',
                on_or_before=f"{index_date_variable}",
                date_format="YYYY-MM-DD",
            ...
            ### HES APC
            prior_angina_events_icd10_hes=patients.admitted_to_hospital(
                returning='binary_flag',
                with_these_diagnoses=angina_icd10,
                on_or_before=f"{index_date_variable}",
                date_format="YYYY-MM-DD",
            ...
            cov_bin_angina=patients.maximum_of(
                "prior_angina_events_snomed", "prior_angina_events_icd10_hes",
            ),
