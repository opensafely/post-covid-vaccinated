...
def generate_common_variables(index_date_variable):
    ...
    tmp_cov_bin_lipid_medications_dmd=patients.with_these_clinical_events(
        lipid_lowering_dmd,
        returning='binary_flag',
        on_or_before=f"{index_date_variable}",
        return_expectations={"incidence": 0.01},
    ...
    ### dmd: dictionary of medicines and devices
    tmp_cov_bin_antiplatelet_medications=patients.with_these_clinical_events(
        antiplatelet_dmd,
        returning='binary_flag',
        on_or_before=f"{index_date_variable}",
        return_expectations={"incidence": 0.01},
    ...
    ### dmd: dictionary of medicines and devices
    tmp_cov_bin_anticoagulation_medications=patients.with_these_clinical_events(
        anticoagulant_dmd, 
        returning='binary_flag',
        on_or_before=f"{index_date_variable}",
        return_expectations={"incidence": 0.01},
    ...
    ### dmd: dictionary of medicines and devices
    tmp_cov_bin_combined_oral_contraceptive_pill_dmd=patients.with_these_clinical_events(
        cocp_dmd, 
        returning='binary_flag',
        on_or_before=f"{index_date_variable}",
        return_expectations={"incidence": 0.01},
    ...
    tmp_cov_bin_hormone_replacement_therapy_dmd=patients.with_these_clinical_events(
        hrt_dmd, 
        returning='binary_flag',
        on_or_before=f"{index_date_variable}",
        return_expectations={"incidence": 0.01},
