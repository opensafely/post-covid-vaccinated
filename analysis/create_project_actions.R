...
actions_list <- splice(
  ...
  action(
    ...
    moderately_sensitive = list(hosp_events_by_region = "output/review/descriptives/hospitalised_covid_event_counts_by_region_vaccinated.csv")),
  ...
  action(
    ...
    moderately_sensitive = list(
    hosp_events_by_region = "output/review/descriptives/hospitalised_covid_event_counts_by_region_electively_unvaccinated.csv")))
